...
export const SOURCES: Record<string,{title:string;url:string;publisher:string;published?:string;checked:string;scope:string}> = {
 ...
 aadhaar:{title:'UIDAI official services',url:'https://uidai.gov.in/en/',publisher:'UIDAI',checked:'2026-09-18',scope:'Official service entry point. Thodu does not reproduce unverified current app screens, fees, or appointment availability.'},
...
export const GUIDES: Guide[] = [
 ...
 {te:'KYC పూర్తయిందో మీ సంస్థలోనే నిర్ధారించుకోండి. తోడు మీ స్థితిని తనిఖీ చేయదు లేదా KYC పూర్తి చేయదు.',en:'Confirm completion with your provider. Thodu cannot check your status or complete your KYC.'}
 ...
 {te:'కింద ఉన్న DigiLocker అధికారిక లింక్ తెరవండి. పత్రాలు ఈ యాప్‌కు అప్‌లోడ్ చేయవద్దు.',en:'Open the official DigiLocker link below. Do not upload identity documents to Thodu.'},
 ...
 {te:'ధృవపత్రం రూపొందితే వచ్చిన నిర్ధారణను భద్రంగా ఉంచండి. తోడు మీ ధృవపత్రాన్ని సమర్పించదు.',en:'Keep the acknowledgement after successful certificate generation. Thodu does not submit your certificate.'}
